...
describe StyleChecker, "#violations" do
  it "returns a collection of computed violations" do
    ...
    expected_violations = ["C:  1: 21: Unnecessary spacing detected.", 
                           "C:  1:  9: Space inside parentheses detected.", 
                           "C:  1: 11: Space inside parentheses detected.", 
                           "C:  1: 21: Trailing whitespace detected."]
  ...
  context "for a Ruby file" do
    context "with style violations" do
      it "returns violations" do
        ...
        expected_violations = ["C:  1:  9: Unnecessary spacing detected.",
                               "C:  1:  9: Trailing whitespace detected."]
